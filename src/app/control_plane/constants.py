...
AUTOMATION_LEVELS = frozenset(
    {AUTOMATION_MANUAL, AUTOMATION_SUPERVISED, AUTOMATION_AUTONOMOUS}
)
...
ASSIGNMENT_STATUSES = frozenset(
    {ASSIGNMENT_STATUS_ACTIVE, ASSIGNMENT_STATUS_EXCLUDED}
)
...
COST_UNITS = frozenset(
    {COST_UNIT_USD, COST_UNIT_TOKENS, COST_UNIT_CHARACTERS, COST_UNIT_REQUESTS}
)
...
BUDGET_PERIODS = frozenset(
    {BUDGET_PERIOD_DAILY, BUDGET_PERIOD_WEEKLY, BUDGET_PERIOD_MONTHLY}
)
